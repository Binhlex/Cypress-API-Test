...
Cypress.Commands.add('updateUserEmail', (newEmail) => {
  cy.readFile('cypress/fixtures/users.json', (err, data) => {
    if (err) {
      return console.error(err)
    }
  }).then((data) => {
    data.email = newEmail
    cy.writeFile('cypress/fixtures/users.json', JSON.stringify(data))
  })
})
